# -*- coding: utf-8 -*-
"""김제 인버터 분해 CV - 광주 08-27 방법론(A/B/C, 사전등록기준)을 김제에 적용.

## 배경
사용자 09-03 지시("김제만 준비해서 자정에 돌려"). 광주(08-27, 8개 수평
전부 완료)·부안(08-31, 단순화된 단일트랙 버전)에 이어 세 번째 지역.
김제는 인버터분해 스크립트가 아직 없어서 신규 작성한다.
...
OUT = HERE / "outputs" / "인버터_분해교차검증_v1_gimje_2026-09-03"
