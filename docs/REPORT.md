...
## 9. 4지역 4계절 기준선 재검증 결과

2026-09-14부터 계절은 실제 목표월 기준의 기상학적 4계절로 통일한다.
climatology는 반드시 각 walk-forward 폴드의 시험 시작일 이전 학습행만 사용한다.
기존 광주 기준선의 전체 계절 평균 계산은 폐기하고 폴드 내부 결과로 교체했다.

| 지역 | 계절 | 모델 MAE 개선율 | 모델 RMSE 개선율 | 표본 | 판정 |
|---|---|---:|---:|---:|---|
| 광주 | 봄 | 54.95% | 49.73% | 91일 | 표본충분 |
| 광주 | 여름 | 49.82% | 48.85% | 129일 | 표본충분 |
| 광주 | 가을 | 62.78% | 55.94% | 13일 | 판정보류 |
| 광주 | 겨울 | 47.61% | 43.89% | 88일 | 표본충분 |
| 김제 | 봄 | 71.17% | 65.53% | 180일 | 표본충분 |
| 김제 | 여름 | 57.97% | 55.07% | 146일 | 표본충분 |
| 김제 | 가을 | 62.88% | 54.14% | 99일 | 표본충분 |
| 김제 | 겨울 | 66.84% | 61.09% | 180일 | 표본충분 |
| 영광 | 봄 | 67.73% | 56.62% | 183일 | 표본충분 |
| 영광 | 여름 | 56.96% | 53.89% | 157일 | 표본충분 |
| 영광 | 가을 | 60.33% | 50.96% | 98일 | 표본충분 |
| 영광 | 겨울 | 64.11% | 58.41% | 180일 | 표본충분 |

부안은 라이브 브릿지 재검증은 완료됐지만, 동일한 폴드 내부 climatology 표는 별도 산출 전까지 보류한다. 이 표는 후보 검증용이며 공식 모델 교체나 운영 승격을 의미하지 않는다.

국내 근거는 계절·기상조건 분류(김백천 외, 2021), 과거 발전량·기상예보 입력(김정원, 2019), 상관분석 기반 변수선정(박건하·김종찬, 2025), 학습기간 검토(이용준 외, 2026)를 지지한다. 반면 정확한 `4계절+폴드 내부 climatology+30일 expanding` 조합은 국내 동일 재현 근거가 확인되지 않아 프로젝트 자체 검증 설계로 표시한다.
...
## 12. 종합보고서 후속 수정 요구사항 — 09.11 사용자 피드백
